...
namespace Geeks.Practices.Arrays.Basic
{
    ...
    public class ShortestUnorderedSubArray
    {
        ...
        public static void RunLinq()
        {
            ...
            foreach (var test in tests)
            {
                ...
                if (n > 2)
                {
                    ...
                    if (elements.Skip(1).Select((x, i) => x > elements[i]).Distinct().Count() > 1)
                    {
                        result = 3;
                    }
                }
        ...
        public static void RunSingleLineLinq()
        {
            ...
            foreach (var test in tests)
            {
                Console.WriteLine(test.Skip(1).Select((x, i) => x > test[i]).Distinct().Count() > 1 ? 3 : 0);
            }
        }
        ...
        public static void RunAnother()
        {
            ...
            foreach (var test in tests)
            {
                ...
                if (n > 2)
                {
                    ...
                    var flag = number < (number = scanner.NextPositiveInt());
                    while (scanner.HasNext)
                    {
                        if (flag == number < (number = scanner.NextPositiveInt())) continue;
                        result = 3;
                        break;
                    }
                }
