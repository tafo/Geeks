    ...
    public class MinimizeSumOfProduct
    {
        ...
        public static void Run5()
        {
            ...
            foreach (var test in tests)
            {
                ...
                var leftNumbers = StringScanner.GetPositiveLong(test[1], n).OrderBy(x => x);
                var rightNumbers = StringScanner.GetPositiveLong(test[2], n).OrderByDescending(x => x).ToArray();
        ...
        public static void Run4()
        {
            ...
            {
                var n = int.Parse(test[0]);
                var leftNumbers = StringScanner.GetPositiveLong(test[1], n);
                var rightNumbers = StringScanner.GetPositiveLong(test[2], n);
        ...
        public static void Run3()
        {
            ...
            {
                var n = int.Parse(test[0]);
                var leftNumbers = StringScanner.GetPositiveLong(test[1], n).OrderBy(x => x).ToArray();
                var rightNumbers = StringScanner.GetPositiveLong(test[2], n).OrderByDescending(x => x).ToArray();
                long sum = 0;
                for (var i = 0; i < n; i++)
                {
